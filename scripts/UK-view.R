...
d2.2v = reflow_dynamics(qread(file.path(covid_uk_path, "2.2V-dynamics.qs")));
t2.2v =   reflow_totals(qread(file.path(covid_uk_path, "2.2V-totals.qs")));
...
ggsave(file.path(covid_uk_path, "fig-lockdown-a.pdf"), plot_grid(pla1, pla2, ncol = 1, align = "hv", axis = "bottom"), 
  width = 12, height = 12, units = "cm", useDingbats = F);
ggsave(file.path(covid_uk_path, "fig-lockdown-b.pdf"), plb, width = 8, height = 6, units = "cm", useDingbats = F);
ggsave(file.path(covid_uk_path, "fig-lockdown-c.pdf"), plR, width = 8, height = 6, units = "cm", useDingbats = F);
...
ggsave(file.path(covid_uk_path, "fig-misc-a.pdf"), pla, width = 9, height = 6, units = "cm", useDingbats = F);
ggsave(file.path(covid_uk_path, "fig-misc-b.pdf"), plb, width = 9, height = 6, units = "cm", useDingbats = F);
...
f = plot_grid(pl1, pl2, pl3, ncol = 1, rel_heights = c(6, 6, 10), labels = c("a", "b", "c"), label_size = 9);
ggsave(file.path(covid_uk_path, "full-7.pdf"), f, width = 20, height = 22, units = "cm", useDingbats = F);
...
googen = fread(file.path(covid_uk_path, "data", "Global_Mobility_Report.csv")); # Google global mobility report
...
ggsave(file.path(covid_uk_path, "fig-variation.pdf"), f, width = 24, height = 6, units = "cm", useDingbats = F);
ggsave(file.path(covid_uk_path, "/fig-variation.png"), f, width = 24, height = 6, units = "cm");
